...
- [x] **Phase 3 按真实规则重做**:移除贵族/徽章 → **进化(回合末免费动作,显式操作)** + **稀有/传说卡线**;5 色宝可梦球 + 大师球;胜利 18 分;**真实 90 卡数值**;**官方插画卡面**(PokéAPI)。14 单测 + 2/3/4 人自对弈(0 僵局、~7-9 次进化/局)
- [ ] Phase 4 启发式 AI(线性加权评估 + 1-ply,终局 2-ply;目前对手为 greedy 基线)
